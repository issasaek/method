...
\begin{enumerate}
    ...
    \item $t$の任意の原始的述語$f$について，$f$が$n$項述語記号の$i$番目であり，かつ，$\orp{n,i}\neq\orp{2,0}$であるとする．このとき，下記(1)(2)の型式に後述の代入を行った結果のいずれかが$t$のメンバーである．また，$t$が理論ならば当該代入結果のいずれかが$t$の公理である．さらに，(3)に後述の代入を行った結果が$u$のメンバーである．
    ...
    \begin{align}
        ...
        (\exists x)(x = \beta).
    \end{align}
    代入は以下のように行う．\kagi{$ R\alpha_1\dots\alpha_n $}の\kagi{$ R $}に$f$を，\kagi{$ \alpha_1\dots\alpha_n $}に$n$個の変項を並べて代入する．
